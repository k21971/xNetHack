...
NETHACK_GIT="/home/build/xNetHack"
...
NHSUBDIR="xnethack-7.0.0.1"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/xnethack-7.0.0.1/var/"
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-xnh7001"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-xnh7001"
...
NETHACKBIN="$NETHACK_GIT/src/xnethack"
