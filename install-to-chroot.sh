...
NHSUBDIR="xnethack-8.0.0"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/xnethack-8.0.0/var/"
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-xnh800"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-xnh800"
